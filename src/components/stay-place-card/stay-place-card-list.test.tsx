...
import StayPlaceCardList from './stay-place-card-list';

describe('Component: StayPlaceCardList', () => {
  ...
  it ('should render correctly', () => {
    const expectedTestId = 'stayPlaceCardList';

    render(
      <Provider store={mockStore}>
        <HistoryRouter history={createMemoryHistory()}>
          <HelmetProvider>
            <StayPlaceCardList onOfferClick={vi.fn} onOfferHover={vi.fn} />
          </HelmetProvider>
        </HistoryRouter>
      </Provider>
    );
